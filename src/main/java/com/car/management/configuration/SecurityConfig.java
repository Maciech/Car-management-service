    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/cars/getAllMake").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/cars/getAllModelByMake/**").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/cars/getYearRange").permitAll()
                        .requestMatchers(HttpMethod.GET, "/api/cars/getTrims").permitAll()
